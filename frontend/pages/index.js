				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
					<div className="text-center">
						...
						<p className="text-lg text-blue-200 mb-12 max-w-2xl mx-auto">
							Make smarter betting decisions with our advanced
				...
				<div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
					<div className="p-8">
						...
						<p className="text-gray-600 mb-8 text-lg">
							Enter your betting details below and let our AI
							analyze the potential value of your bet.
						</p>
						...
						<form onSubmit={handleSubmit} className="space-y-6">
							...
							<div>
								...
								>
									...
									{Object.keys(teamData.football || {}).map(
										(team) => (
							...
							{formData.team && (
								<div>
									...
									>
										...
										{teamData.football[formData.team]?.map(
											(player) => (
												<option
													key={player}
													value={player}
							...
							<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
								<div>
									...
									<p className="text-sm text-gray-500 mt-1 italic">
										Enter the threshold number for your
										action
									</p>
								</div>
